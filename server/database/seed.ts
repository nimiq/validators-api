...
import { NewValidator, PayoutType } from "../utils/drizzle"

export const seed: Promise<NewValidator>[] = [
  {
  ...
  if (!validator.icon)
    validator.icon = await Identicons.default.toDataUrl(validator.address)
  return validator
})
