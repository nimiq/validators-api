import { PROOF_OF_STAKE_FORK_BLOCK, PROOF_OF_STAKE_FORK_DATE, PROOF_OF_WORK_EMISSION_SPEED, PROOF_OF_WORK_EMISSION_TAIL_REWARD, PROOF_OF_WORK_EMISSION_TAIL_START, PROOF_OF_WORK_INITIAL_SUPPLY } from 'nimiq-albatross-policy'
